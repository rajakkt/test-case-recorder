...
function toZephyrJson() {
  ...
  return {
    ...
    objective: state.config.objective || "Generated from Smart Script browser session.",
...
function toZephyrXml() {
  ...
  return [
    ...
    "      <attachments/>",
    "      <confluencePageLinks/>",
    "      <createdBy>Smart Script</createdBy>",
    ...
    `      <objective>${safeCdata(state.config.objective || "Generated from Smart Script browser session.")}</objective>`,
